            ...
            fetchData(url.geo(searchField.value), function (locations) {
                ...
                if (locations && locations.length) {
                    ...
                    addEventOnElements(items, "click", function () {
                        toggleSearch();
                        searchResult.classList.remove("active");
                        searchField.value = ""; // added 
                    });
                } else {
                    searchResult.querySelector("[data-search-list]").innerHTML = `
                        <li class="view-item">
                            <p class="body-1">No locations found</p>
                        </li>
                    `;
                }
            });
        ...
        card.innerHTML = `
            ...
            <ul class="meta-list">
                ...
                <li class="meta-item">
                    ...
                    <p class="tile-3 meta-text">${module.getDate(dateUnix, timezone)}</p>
                </li>
                <li class="meta-item">
                    <span class="m-icon">location_on</span>

                    <p class="tile-3 meta-text" data-location></p>
                </li>
            ...
            card.innerHTML = `
                ...
                <div class="highlight-list">
                    ...
                    <div class="card card-sm highlight-card two">
                        ...
                        <h3 class="title-3">Sunrise & Sunset
                        </h3>
